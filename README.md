...
Fra dette produserer systemet en prognose: er anlegget på vei mot å krysse den gjeldende grensen, og i så fall — omtrent når. Driftsleder/fiskehelseansvarlig får et varsel 2-3 uker før terskelen forventes nådd, med nok tid til å planlegge og iverksette tiltak fremfor å reagere i siste liten.

[ANTAGELSE: Presentasjonsformen er et web-dashboard (status per anlegg, trendlinje, varselnivå), ikke en ren varslingstjeneste via SMS/e-post — dette er foreløpig åpent og bør avklares med Ella.]

## Hva gjør dette annerledes

BarentsWatch Fiskehelse, og tredjepartsverktøy som det åpne prosjektet «oppdretter» (varselsystem for lakselus, sykdom, soner og brønnbåter fra åpne norske kilder), viser og aggregerer *dagens* og *historiske* tall godt. De svarer på «hva er situasjonen nå». Marins differensiering er å svare på «hva vil situasjonen være om 2-3 uker» — en prognose, ikke bare et øyeblikksbilde.

Dette er ikke en unik teknisk «vollgrav» — det er en tydelig retningsvalgt fordel (prediktivt fremfor observerende), og skal presenteres ærlig som det. [ANTAGELSE: Selve prediksjonsmodellens nøyaktighet og robusthet er ikke definert ennå og er en sentral usikkerhet i prosjektet, ikke en avklart styrke.]
